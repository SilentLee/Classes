...
class BFW_BasicClass : public CG_Sprite
{
	// 武器属性
private:
...
public:
	static BFW_BasicClass* createWithPosInSquare(std::string fileName, int posX, int posY, PROPERTY_WP mPropertyWp);
	static BFW_BasicClass* createWithAbsolutePos(std::string fileName, int posX, int posY, PROPERTY_WP mPropertyWp);
	static BFW_BasicClass* createWithRelativePos(std::string fileName, float posX, float posY, PROPERTY_WP mPropertyWp);
	static BFW_BasicClass* createWithRealAbsolutePos(std::string fileName, int posX, int posY, PROPERTY_WP mPropertyWp);
