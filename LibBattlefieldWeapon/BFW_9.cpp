...
BFW_9* BFW_9::createWithPosInSquare(std::string fileName, int posX, int posY)
{
	BFW_9* ret = new BFW_9();
...
BFW_9* BFW_9::createWithRealAbsolutePos(std::string fileName, int posX, int posY)
{
	BFW_9* ret = new BFW_9();
...
BFW_9* BFW_9::createWithAbsolutePos(std::string fileName, int posX, int posY)
{
	BFW_9* ret = new BFW_9();
...
BFW_9* BFW_9::createWithRelativePos(std::string fileName, float posX, float posY)
{
	BFW_9* ret = new BFW_9();
...
// 初始化函数
bool BFW_9::initWithPosInSquare(const std::string& filename, int posX, int posY)
{
	// 载入卡牌9参数
...
bool BFW_9::initWithAbsolutePos(const std::string& filename, int posX, int posY)
{
	// 载入卡牌9参数
	PROPERTY_WP propertyWp = CU_CardLoader::getCardParam(CARD_TYPE_9);
...
bool BFW_9::initWithRelativePos(const std::string& filename, float posX, float posY)
{
	// 载入卡牌9参数
	PROPERTY_WP propertyWp = CU_CardLoader::getCardParam(CARD_TYPE_9);
...
bool BFW_9::initWithRealAbsolutePos(const std::string& filename, int posX, int posY)
{
	// 载入卡牌9参数
	PROPERTY_WP propertyWp = CU_CardLoader::getCardParam(CARD_TYPE_9);
