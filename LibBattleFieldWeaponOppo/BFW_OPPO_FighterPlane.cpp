...
BFW_OPPO_FighterPlane* BFW_OPPO_FighterPlane::createWithPosInSquare(std::string fileName, int posX, int posY)
{
	BFW_OPPO_FighterPlane* ret = new BFW_OPPO_FighterPlane();
...
BFW_OPPO_FighterPlane* BFW_OPPO_FighterPlane::createWithRealAbsolutePos(std::string fileName, int posX, int posY)
{
	BFW_OPPO_FighterPlane* ret = new BFW_OPPO_FighterPlane();
...
BFW_OPPO_FighterPlane* BFW_OPPO_FighterPlane::createWithAbsolutePos(std::string fileName, int posX, int posY)
{
	BFW_OPPO_FighterPlane* ret = new BFW_OPPO_FighterPlane();
...
BFW_OPPO_FighterPlane* BFW_OPPO_FighterPlane::createWithRelativePos(std::string fileName, float posX, float posY)
{
	BFW_OPPO_FighterPlane* ret = new BFW_OPPO_FighterPlane();
...
// 初始化函数
bool BFW_OPPO_FighterPlane::initWithPosInSquare(const std::string& filename, int posX, int posY)
{
	// 载入战斗机参数
...
bool BFW_OPPO_FighterPlane::initWithAbsolutePos(const std::string& filename, int posX, int posY)
{
	// 载入战斗机参数
	PROPERTY_WP propertyWp = CU_CardLoader::getCardParam(CARD_TYPE_FIGHTER_PLANE);
...
bool BFW_OPPO_FighterPlane::initWithRelativePos(const std::string& filename, float posX, float posY)
{
	// 载入战斗机参数
	PROPERTY_WP propertyWp = CU_CardLoader::getCardParam(CARD_TYPE_FIGHTER_PLANE);
...
bool BFW_OPPO_FighterPlane::initWithRealAbsolutePos(const std::string& filename, int posX, int posY)
{
	// 载入战斗机参数
	PROPERTY_WP propertyWp = CU_CardLoader::getCardParam(CARD_TYPE_FIGHTER_PLANE);
...
void BFW_OPPO_FighterPlane::initPhysicsBody()
{
